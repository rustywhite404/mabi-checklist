const checklistData = [
  {
    ...
    items: [
      ...
      { npc: '말콤', gives: '말콤의 폭신한 양털 베개 1개', receives: '거미줄 5개', limit: '일 1회' },
  ...
  },  
  {
    ...
    items: [
      ...
      { npc: '제롬', gives: '리코타 치즈 샐러드 1개', receives: '실크 4개', limit: '일 1회' },
      { npc: '제롬', gives: '크림소스 스테이크 1개', receives: '상급 실크 2개', limit: '일 1회' },
