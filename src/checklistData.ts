const checklistData = [
  ...
  },  
  {
    ...
    items: [
      ...
      { npc: '스튜어트', gives: '연금술 부스러기 1개', receives: '얼음의 결정 1개', limit: '일 5회' },
      { npc: '스튜어트', gives: '연금술 부스러기 1개', receives: '전기의 결정 1개', limit: '일 5회' },
      { npc: '스튜어트', gives: '연금술 부스러기 1개', receives: '광휘의 결정 1개', limit: '일 5회' },
      { npc: '스튜어트', gives: '연금술 부스러기 1개', receives: '봉인의 결정 1개', limit: '일 5회' },
      ...
      { npc: '발터', gives: '참사랑어 5개', receives: '하트 토큰 1개', limit: '일 2회' },
